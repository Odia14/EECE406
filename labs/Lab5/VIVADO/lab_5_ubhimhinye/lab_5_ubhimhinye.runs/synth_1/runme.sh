...
HD_PWD='C:/EECE406/labs/Lab5/VIVADO/lab_5_ubhimhinye/lab_5_ubhimhinye.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LogicalOps.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LogicalOps.tcl
