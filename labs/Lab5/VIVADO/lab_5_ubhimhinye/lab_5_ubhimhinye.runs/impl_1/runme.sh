...
HD_PWD='C:/EECE406/labs/Lab5/VIVADO/lab_5_ubhimhinye/lab_5_ubhimhinye.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log LogicalOps.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source LogicalOps.tcl -notrace
