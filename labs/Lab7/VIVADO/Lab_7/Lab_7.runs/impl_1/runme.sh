...
HD_PWD='C:/EECE406/labs/Lab7/VIVADO/Lab_7/Lab_7.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log arbi_seq_counter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source arbi_seq_counter.tcl -notrace
