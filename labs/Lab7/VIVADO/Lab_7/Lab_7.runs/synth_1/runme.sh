...
HD_PWD='C:/EECE406/labs/Lab7/VIVADO/Lab_7/Lab_7.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log arbi_seq_counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source arbi_seq_counter.tcl
