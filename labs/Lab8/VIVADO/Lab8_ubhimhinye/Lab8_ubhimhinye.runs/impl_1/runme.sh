...
HD_PWD='C:/EECE406/labs/Lab8/VIVADO/Lab8_ubhimhinye/Lab8_ubhimhinye.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log seq_mult.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source seq_mult.tcl -notrace
