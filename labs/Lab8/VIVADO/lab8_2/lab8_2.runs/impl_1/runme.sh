...
HD_PWD='C:/EECE406/labs/Lab8/VIVADO/lab8_2/lab8_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log seq_mult_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source seq_mult_top.tcl -notrace
